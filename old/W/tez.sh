...
pussy1() {
	declare -a CMD=(
		...
		#0 -  Test if image is loading properly
		"curl -A \"Twitterbot\" https://res.cloudinary.com/dzma12njh/image/upload/6.webp -I"
...
panty() {
	pussy1 2>&1 | tee -a tez.sh.txt
	# booty1 2>&1 | tee -a tez.sh.txt
